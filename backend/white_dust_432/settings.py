"""
Django settings for white_dust_432 project.
...
ROOT_URLCONF = 'white_dust_432.urls'
...
WSGI_APPLICATION = 'white_dust_432.wsgi.application'
...
SPECTACULAR_SETTINGS = {
    ...
    "TITLE": "white_dust_432 API",
    "DESCRIPTION": "API documentation for white_dust_432 App",
    "VERSION": "v1",
}
